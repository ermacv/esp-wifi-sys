...
- final ELF: `wifi-sta`
- ELF SHA-256: `caa3a690fb7ccb04e72fcb59f3c552d1956acda662b8e99a33a986a05ed69e44`
- strict vendor roots: 6
- Rust boundaries retaining vendor fallback: 1
- stateful or not-yet-proven runtime roots: 5
...
- vendor functions reachable from those roots: 16
...
| `.critical.text.wifi_strict.lmac_release_txop_queue` | `0x400de906` | 38 | `flash-mapped` |
| `.critical.text.wifi_strict.lmac_request_txop_queue` | `0x400de92c` | 90 | `flash-mapped` |

## Final-link interposition

| boundary | replacement | mode | `__real_*` target |
|---|---:|---|---|
| `calloc` | `0x400c0910` | GNU `--wrap` boundary | - |
| `chm_return_home_channel` | `0x400c0324` | GNU `--wrap` boundary | - |
| `chm_start_op` | `0x400c026c` | GNU `--wrap` boundary | - |
...
| `cnx_node_alloc` | `0x400cedce` | GNU `--wrap` boundary | - |
| `cnx_node_search` | `0x400cef20` | retained replacement only | - |
| `cnx_remove_from_blacklist` | `0x2f00552e` | retained replacement only | - |
| `dbg_dump_rx_ppdu` | `0x400c1d68` | retained replacement only | - |
| `dbg_dump_rx_sigb` | `0x400c1d6a` | retained replacement only | - |
| `dbg_read_tx_ppdu` | `0x400c1d6a` | retained replacement only | - |
...
| `esp_test_rx_parse_mu` | `0x400c1d68` | direct public alias | `0x2f801178` (ROM export) |
| `esp_test_rx_process_complete` | `0x400c1d72` | direct public alias | `0x2f801158` (ROM export) |
| `esp_test_tx_enab_statistics` | `0x400c1d6e` | direct public alias | `0x2f801144` (ROM export) |
| `esp_wifi_internal_reg_rxcb` | `0x400cef28` | retained replacement only | - |
| `esp_wifi_register_mgmt_frame_internal` | `0x400cefa8` | retained replacement only | - |
| `esp_wifi_set_config` | `0x400cf00a` | retained replacement only | - |
| `esp_wifi_set_country` | `0x400cf0c2` | retained replacement only | - |
| `esp_wifi_set_inactive_time` | `0x400cf302` | retained replacement only | - |
| `esp_wifi_set_max_tx_power` | `0x400cf44a` | retained replacement only | - |
| `esp_wifi_set_mode` | `0x400cf4e8` | retained replacement only | - |
| `esp_wifi_set_promiscuous` | `0x400cf540` | retained replacement only | - |
| `esp_wifi_set_protocols` | `0x400cf5b4` | retained replacement only | - |
| `esp_wifi_set_ps` | `0x400cf88e` | retained replacement only | - |
| `esp_wifi_stop` | `0x400cf8fc` | retained replacement only | - |
| `ets_delay_us` | `0x400c0bca` | direct public alias | `0x2f80003c` (ROM export) |
| `free` | `0x400c0b5a` | GNU `--wrap` boundary | - |
| `hal_crypto_set_key_entry` | `0x400c1468` | retained replacement only | - |
| `hal_mac_get_txq_complete` | `0x2f005340` | direct public alias | `0x2f800d44` (ROM export) |
| `hal_mac_get_txq_state` | `0x400c0cc0` | direct public alias | `0x2f800d3c` (ROM export) |
| `ic_get_next_tbtt` | `0x400c0fca` | retained replacement only | - |
| `ieee80211_classify` | `0x400bfe7c` | GNU `--wrap` boundary | - |
| `ieee80211_hostapd_beacon_txcb` | `0x400c0d36` | GNU `--wrap` boundary | - |
| `ieee80211_mgmt_output` | `0x400c03a6` | GNU `--wrap` boundary | - |
| `ieee80211_search_node` | `0x400cf93e` | direct public alias | `0x2f800ca8` (ROM export) |
| `ieee80211_set_tx_pti` | `0x400c05c0` | direct public alias | `0x2f800cb8` (ROM export) |
| `ieee80211_timer_process` | `0x400c0116` | GNU `--wrap` boundary | - |
| `ieee80211_tx_mgt_cb` | `0x400c0e8e` | retained replacement only | - |
| `lmacTxDone` | `0x2f005492` | direct public alias | `0x2f800dec` (ROM export) |
| `malloc` | `0x400c07ba` | GNU `--wrap` boundary | - |
| `misc_nvs_deinit` | `0x400cfa46` | retained replacement only | - |
| `misc_nvs_init` | `0x400cfa5a` | retained replacement only | - |
| `net80211_data_ptr_init` | `0x400cfaa0` | retained replacement only | - |
| `os_sleep` | `0x400c0c4c` | GNU `--wrap` boundary | - |
| `pm_extend_tbtt_adaptive_attach` | `0x400cfb62` | retained replacement only | - |
| `pm_extend_tbtt_adaptive_deattach` | `0x400cfbbe` | retained replacement only | - |
| `pm_funcs_deinit` | `0x400cfbf8` | retained replacement only | - |
| `pm_funcs_init` | `0x400cfc04` | retained replacement only | - |
| `pm_on_beacon_rx` | `0x400c1d8c` | direct public alias | `0x2f800e98` (ROM export) |
| `pm_on_coex_schm_status_config` | `0x2f005854` | retained replacement only | - |
| `pm_on_data_rx` | `0x400c1d8e` | direct public alias | `0x2f800e9c` (ROM export) |
| `pm_on_data_tx` | `0x400c1d90` | direct public alias | `0x2f800ea0` (ROM export) |
| `pm_set_beacon_duration` | `0x400c1d92` | retained replacement only | - |
| `pmksa_cache_deinit` | `0x400cfc3c` | retained replacement only | - |
| `pmksa_cache_init` | `0x400cfc6e` | retained replacement only | - |
| `ppTxPkt` | `0x2f0088a6` | retained replacement only | - |
| `pp_create_task` | `0x400cfdb8` | retained replacement only | - |
| `pp_delete_task` | `0x400cfe46` | retained replacement only | - |
| `pp_post` | `0x400bfaea` | GNU `--wrap` boundary | - |
| `rcGetSched` | `0x2f0029ce` | retained replacement only | - |
| `realloc` | `0x400c0a90` | GNU `--wrap` boundary | - |
| `sleep` | `0x400ba572` | GNU `--wrap` boundary | - |
| `sta_rx_cb` | `0x400ac88a` | GNU `--wrap` boundary | - |
| `trc_deinit` | `0x400cff0e` | retained replacement only | - |
| `trc_init` | `0x400cff54` | retained replacement only | - |
| `usleep` | `0x400ba5ce` | GNU `--wrap` boundary | - |
| `vTaskDelay` | `0x400ba5fa` | GNU `--wrap` boundary | - |
...
| `wDev_SnifferRxData` | `0x400c1d90` | retained replacement only | - |
| `wDev_ftm_set_t1t4` | `0x400c1d94` | retained replacement only | - |
| `wDev_isNANPktInValidSlot` | `0x400c1da4` | GNU `--wrap` boundary | - |
| `wDev_record_ftm_data` | `0x400c1d7c` | retained replacement only | - |
| `wdev_csi_rx_process` | `0x400c1d90` | retained replacement only | - |
| `wdev_data_init` | `0x400d00b4` | retained replacement only | - |
| `wifi_assert` | `0x400c1d74` | retained replacement only | - |
| `wifi_deinit_in_caller_task` | `0x400d02a8` | retained replacement only | - |
| `wifi_gpio_debug` | `0x400c1d6c` | retained replacement only | - |
| `wifi_init_in_caller_task` | `0x400d0390` | retained replacement only | - |
| `wifi_log` | `0x400c1d90` | retained replacement only | - |
| `wpa_ap_rx_eapol` | `0x400c1426` | retained replacement only | - |
| `wpa_sm_rx_eapol` | `0x400c13e8` | retained replacement only | - |
...
| `esp_test_set_rx_error_occurs` | `0x400b6cdc` | direct public alias | `0x2f801164` (ROM export) |
| `rcUpdateTxDone` | `0x400c104e` | direct public alias | `0x2f80106c` (ROM export) |
| `rcUpdateAckSnr` | `0x400c1f38` | direct public alias | `0x2f801064` (ROM export) |
| `rcTxUpdatePer` | `0x400c1f88` | direct public alias | `0x2f801060` (ROM export) |
| `trc_update_ifx_phy_mode` | `0x400d1b00` | direct public alias | - |
| `rcAttach` | `0x400d0fec` | direct public alias | - |
| `rcUpdatePhyMode` | `0x400d1052` | direct public alias | - |
| `rc_get_default_sched` | `0x400d1036` | direct public alias | - |
| `rc_get_G6M_sched` | `0x400d1044` | direct public alias | - |
| `lmacRequestTxopQueue` | `0x400de92c` | direct public alias | - |
| `lmacReleaseTxopQueue` | `0x400de906` | direct public alias | - |
...
| `ic_set_mac` | `0x400d0482` | direct public alias | - |
| `ic_set_rx_policy` | `0x400d04d2` | direct public alias | - |
| `ic_set_rx_policy_ubssid_check` | `0x400d0564` | direct public alias | - |
| `ieee80211_getmgtframe` | `0x400d067c` | direct public alias | - |
...
| `ieee80211_post_hmac_tx` | `0x400d06f8` | direct public alias | `0x2f800cc0` (ROM export) |
| `ieee80211_crypto_encap` | `0x400c0002` | direct public alias | `0x2f800cac` (ROM export) |
| `ieee80211_align_eb` | `0x400d059c` | direct public alias | `0x2f800c7c` (ROM export) |
| `ieee80211_set_tx_desc` | `0x400d07f4` | direct public alias | `0x2f800c98` (ROM export) |
