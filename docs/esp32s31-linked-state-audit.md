...
- final ELF: `wifi-sta`
- ELF SHA-256: `ab0cd11b235ca31834e5d5a354cd7454ac355e374ea98242bb4963b1b85b2406`
- strict vendor roots: 11
- Rust boundaries retaining vendor fallback: 1
- stateful or not-yet-proven runtime roots: 9
- temporary evidenced MMIO-only roots: 1
...
- vendor functions reachable from those roots: 24
...
- live mutable blob globals outside the strict-root graph: 185 symbols / 22212 bytes
- Rust strict static sections: 82 sections / 312441 bytes
...
|---|---:|---|---:|---|
| `g_wifi_nvs` | `0x2f0196a0` | `s_wifi_nvs` | 1440 | `internal SRAM` / `.bss` |
...
|---|---:|---:|---|
| `.data.wifi` | `0x2f01a548` | 408 | `internal SRAM` |
| `.critical.data.wifi_strict.radio_executor` | `0x2f01a6e0` | 940 | `internal SRAM` |
| `.critical.data.wifi_strict.commands` | `0x2f01aa8c` | 17196 | `internal SRAM` |
| `.critical.bss.wifi_strict.trc_default_contexts` | `0x2f01fe0c` | 456 | `internal SRAM` |
| `.critical.bss.wifi_strict.net80211_power_save` | `0x2f01ffd4` | 320 | `internal SRAM` |
| `.critical.bss.wifi_strict.phy_channel` | `0x2f020114` | 48 | `internal SRAM` |
| `.critical.bss.wifi_strict.tbtt_adaptive_data` | `0x2f020144` | 4 | `internal SRAM` |
| `.critical.bss.wifi_strict.pmksa_cache` | `0x2f020148` | 20 | `internal SRAM` |
| `.critical.bss.wifi_strict.channel_resources` | `0x2f02015c` | 256 | `internal SRAM` |
| `.critical.bss.wifi_strict.misc_nvs_initialized` | `0x2f02025c` | 1 | `internal SRAM` |
| `.critical.bss.wifi_strict.misc_nvs` | `0x2f020260` | 60 | `internal SRAM` |
| `.critical.data.wifi_strict.rx_queue` | `0x2f02029c` | 4 | `internal SRAM` |
| `.critical.bss.wifi_strict.esf_large_rx_slots` | `0x2f0202a0` | 59008 | `internal SRAM` |
| `.critical.bss.wifi_strict.esf_large_rx_claims` | `0x2f02e920` | 8 | `internal SRAM` |
| `.critical.bss.wifi_strict.esf_management_slots` | `0x2f02e928` | 27904 | `internal SRAM` |
| `.critical.bss.wifi_strict.esf_aggregate_rx_owners` | `0x2f035628` | 8 | `internal SRAM` |
| `.critical.bss.wifi_strict.esf_aggregate_rx_headers` | `0x2f035630` | 288 | `internal SRAM` |
| `.critical.data.wifi_strict.esf_prearm_hart` | `0x2f035750` | 4 | `internal SRAM` |
| `.critical.bss.wifi_strict.esf_management_claims` | `0x2f035754` | 4 | `internal SRAM` |
| `.critical.bss.wifi_strict.tx_ampdu_owners` | `0x2f035758` | 1424 | `internal SRAM` |
| `.critical.bss.wifi_strict.tx_ampdu_completion_state` | `0x2f035ce8` | 584 | `internal SRAM` |
| `.critical.data.wifi_strict.tx_backoff` | `0x2f035f30` | 4 | `internal SRAM` |
| `.critical.bss.wifi_strict.rx_recycle_probe` | `0x2f035f34` | 32 | `internal SRAM` |
| `.critical.bss.wifi_strict.rx_recycle_timer` | `0x2f035f54` | 20 | `internal SRAM` |
| `.critical.bss.wifi_strict.rx_metadata_probe` | `0x2f035f68` | 188 | `internal SRAM` |
| `.critical.bss.wifi_strict.indicate_frame_probe` | `0x2f036024` | 12 | `internal SRAM` |
| `.critical.bss.wifi_strict.rx_action_policy` | `0x2f036030` | 1 | `internal SRAM` |
| `.critical.bss.wifi_strict.tx_done_registry` | `0x2f036034` | 40 | `internal SRAM` |
| `.critical.data.wifi_strict.init_global_lock` | `0x2f03605c` | 12 | `internal SRAM` |
| `.critical.data.wifi_strict.init_mac_list_lock` | `0x2f036068` | 12 | `internal SRAM` |
| `.critical.bss.wifi_strict.init_interrupt_lock` | `0x2f036074` | 4 | `internal SRAM` |
| `.critical.bss.wifi_strict.data_rx_channel` | `0x2f036078` | 532 | `internal SRAM` |
| `.critical.bss.wifi_strict.data_rx_slots` | `0x2f03628c` | 4160 | `internal SRAM` |
| `.critical.bss.wifi_strict.data_tx_channel` | `0x2f0372cc` | 276 | `internal SRAM` |
| `.critical.bss.wifi_strict.data_tx_slots` | `0x2f0373e0` | 51584 | `internal SRAM` |
| `.critical.data.wifi_strict.basic_secondary_schedule` | `0x2f043d60` | 12 | `internal SRAM` |
| `.critical.bss.wifi_strict.critical_probe` | `0x2f043d6c` | 24 | `internal SRAM` |
| `.critical.bss.wifi_strict.tx_queue_process_hil` | `0x2f043d84` | 156 | `internal SRAM` |
| `.critical.bss.wifi_strict.tx_queue_state` | `0x2f043e20` | 236 | `internal SRAM` |
| `.critical.bss.wifi_strict.tx_trace` | `0x2f043f0c` | 2312 | `internal SRAM` |
| `.critical.bss.wifi_strict.pm_beacon_offset_functions` | `0x2f044814` | 68 | `internal SRAM` |
| `.critical.bss.wifi_strict.esf_cold_wifi_648` | `0x2f044860` | 5248 | `internal SRAM` |
| `.critical.bss.wifi_strict.rate_contexts` | `0x2f045ce0` | 2432 | `internal SRAM` |
| `.critical.bss.wifi_strict.esf_cold_internal_788` | `0x2f046660` | 1600 | `internal SRAM` |
| `.critical.bss.wifi_strict.wdev_rx_payloads` | `0x2f046ca0` | 54784 | `internal SRAM` |
| `.critical.bss.wifi_strict.esf_cold_internal_1748` | `0x2f0542a0` | 56320 | `internal SRAM` |
| `.critical.bss.wifi_strict.cold_api_envelopes` | `0x2f061ea0` | 48 | `internal SRAM` |
| `.critical.bss.wifi_strict.rate_table_scratch` | `0x2f061ed0` | 212 | `internal SRAM` |
| `.critical.bss.wifi_strict.wifi_interface_phy` | `0x2f061fb0` | 1296 | `internal SRAM` |
| `.critical.bss.wifi_strict.wifi_nvs_cfg_items` | `0x2f0624c0` | 4640 | `internal SRAM` |
| `.critical.bss.wifi_strict.wdev_function_table` | `0x2f0636e0` | 1568 | `internal SRAM` |
| `.critical.bss.wifi_strict.wifi_interface_state` | `0x2f063d00` | 624 | `internal SRAM` |
| `.critical.bss.wifi_strict.wifi_nvs_load_scratch` | `0x2f063f70` | 1024 | `internal SRAM` |
| `.critical.bss.wifi_strict.net80211_function_table` | `0x2f064370` | 336 | `internal SRAM` |
| `.critical.bss.wifi_strict.wdev_rx_descriptor_arena` | `0x2f0644c0` | 384 | `internal SRAM` |
| `.critical.bss.wifi_strict.supplicant_callbacks` | `0x2f064640` | 108 | `internal SRAM` |
| `.critical.bss.wifi_strict.pp_bars` | `0x2f0646ac` | 160 | `internal SRAM` |
| `.critical.bss.wifi_strict.deferred_ap_management` | `0x2f06474c` | 288 | `internal SRAM` |
| `.critical.bss.wifi_strict.management_tx_rejection` | `0x2f06486c` | 64 | `internal SRAM` |
| `.critical.bss.wifi_strict.ap_assoc_rejection` | `0x2f0648ac` | 44 | `internal SRAM` |
| `.critical.bss.wifi_strict.ap_assoc_response_capture` | `0x2f0648d8` | 272 | `internal SRAM` |
| `.critical.data.wifi_strict.critical_hart` | `0x2f0649e8` | 4 | `internal SRAM` |
| `.critical.bss.wifi_strict.critical_state` | `0x2f0649ec` | 8 | `internal SRAM` |
| `.critical.bss.wifi_strict.rx_addba` | `0x2f0649f4` | 15 | `internal SRAM` |
| `.critical.bss.wifi_strict.sta_node` | `0x2f064a04` | 1544 | `internal SRAM` |
| `.critical.bss.wifi_strict.ap_nodes` | `0x2f06500c` | 10400 | `internal SRAM` |
| `.critical.data.wifi_strict.txop_queue_status` | `0x2f0678ac` | 3 | `internal SRAM` |
| `.critical.bss.wifi_strict.net80211_tx_queue` | `0x2f0678c8` | 12 | `internal SRAM` |
| `.critical.bss.wifi_strict.net80211_interfaces` | `0x2f0678d4` | 28 | `internal SRAM` |
| `.critical.bss.wifi_strict.rx_queue` | `0x2f0678f0` | 12 | `internal SRAM` |
| `.critical.bss.wifi_strict.rx_registry` | `0x2f0678fc` | 12 | `internal SRAM` |
| `.critical.bss.wifi_strict.esf_rejections` | `0x2f067908` | 12 | `internal SRAM` |
| `.critical.bss.wifi_strict.rx_recycle_state` | `0x2f067914` | 24 | `internal SRAM` |
| `.critical.bss.wifi_strict.lmac_tx_done_state` | `0x2f06792c` | 16 | `internal SRAM` |
| `.critical.bss.wifi_strict.tx_done_state` | `0x2f06793c` | 12 | `internal SRAM` |
| `.critical.bss.wifi_strict.data_tx_wakers` | `0x2f067948` | 24 | `internal SRAM` |
| `.critical.bss.wifi_strict.ap_join_diagnostics` | `0x2f067960` | 8 | `internal SRAM` |
| `.critical.bss.wifi_strict.critical_callbacks` | `0x2f067968` | 16 | `internal SRAM` |
| `.critical.bss.wifi_strict.tx_block_ack` | `0x2f067978` | 48 | `internal SRAM` |
| `.bss.esp_wifi_async_net80211` | `0x2f0679a8` | 33 | `internal SRAM` |
| `.critical.text.wifi_strict.lmac_release_txop_queue` | `0x400de6d4` | 38 | `flash-mapped` |
| `.critical.text.wifi_strict.lmac_request_txop_queue` | `0x400de6fa` | 90 | `flash-mapped` |

## Final-link interposition

| boundary | replacement | mode | `__real_*` target |
|---|---:|---|---|
| `calloc` | `0x400c1be4` | GNU `--wrap` boundary | - |
| `chm_return_home_channel` | `0x400c15f8` | GNU `--wrap` boundary | - |
| `chm_start_op` | `0x400c1540` | GNU `--wrap` boundary | - |
| `cnx_add_to_blacklist` | `0x2f00552c` | retained replacement only | - |
| `cnx_check_bssid_in_blacklist` | `0x2f005528` | retained replacement only | - |
| `cnx_clear_blacklist` | `0x2f00552e` | retained replacement only | - |
| `cnx_node_alloc` | `0x400cff8a` | GNU `--wrap` boundary | - |
| `cnx_node_search` | `0x400d00dc` | retained replacement only | - |
| `cnx_remove_from_blacklist` | `0x2f00552c` | retained replacement only | - |
| `dbg_dump_rx_ppdu` | `0x400c303c` | retained replacement only | - |
| `dbg_dump_rx_sigb` | `0x400c303e` | retained replacement only | - |
| `dbg_read_tx_ppdu` | `0x400c303e` | retained replacement only | - |
...
| `esp_test_rx_parse_mu` | `0x400c303c` | direct public alias | `0x2f801178` (ROM export) |
| `esp_test_rx_process_complete` | `0x400c3046` | direct public alias | `0x2f801158` (ROM export) |
| `esp_test_tx_enab_statistics` | `0x400c3042` | direct public alias | `0x2f801144` (ROM export) |
| `esp_wifi_internal_reg_rxcb` | `0x400d00e4` | retained replacement only | - |
| `esp_wifi_register_mgmt_frame_internal` | `0x400d0164` | retained replacement only | - |
| `esp_wifi_set_config` | `0x400d01c6` | retained replacement only | - |
| `esp_wifi_set_country` | `0x400d027e` | retained replacement only | - |
| `esp_wifi_set_inactive_time` | `0x400d04be` | retained replacement only | - |
| `esp_wifi_set_max_tx_power` | `0x400d0606` | retained replacement only | - |
| `esp_wifi_set_mode` | `0x400d06a4` | retained replacement only | - |
| `esp_wifi_set_promiscuous` | `0x400d06fc` | retained replacement only | - |
| `esp_wifi_set_protocols` | `0x400d0770` | retained replacement only | - |
| `esp_wifi_set_ps` | `0x400d0a4a` | retained replacement only | - |
| `esp_wifi_stop` | `0x400d0ab8` | retained replacement only | - |
| `ets_delay_us` | `0x400c1e9e` | direct public alias | `0x2f80003c` (ROM export) |
| `free` | `0x400c1e2e` | GNU `--wrap` boundary | - |
| `hal_crypto_set_key_entry` | `0x400c273c` | retained replacement only | - |
| `hal_mac_get_txq_complete` | `0x2f00533e` | direct public alias | `0x2f800d44` (ROM export) |
| `hal_mac_get_txq_state` | `0x400c1f94` | direct public alias | `0x2f800d3c` (ROM export) |
| `ic_get_next_tbtt` | `0x400c229e` | retained replacement only | - |
| `ieee80211_classify` | `0x400c1150` | GNU `--wrap` boundary | - |
| `ieee80211_hostapd_beacon_txcb` | `0x400c200a` | GNU `--wrap` boundary | - |
| `ieee80211_mgmt_output` | `0x400c167a` | GNU `--wrap` boundary | - |
| `ieee80211_search_node` | `0x400d0afa` | direct public alias | `0x2f800ca8` (ROM export) |
| `ieee80211_set_tx_pti` | `0x400c1894` | direct public alias | `0x2f800cb8` (ROM export) |
| `ieee80211_timer_process` | `0x400c13ea` | GNU `--wrap` boundary | - |
| `ieee80211_tx_mgt_cb` | `0x400c2162` | retained replacement only | - |
| `lmacTxDone` | `0x2f005490` | direct public alias | `0x2f800dec` (ROM export) |
| `malloc` | `0x400c1a8e` | GNU `--wrap` boundary | - |
| `misc_nvs_deinit` | `0x400d0c02` | retained replacement only | - |
| `misc_nvs_init` | `0x400d0c16` | retained replacement only | - |
| `net80211_data_ptr_init` | `0x400d0c5c` | retained replacement only | - |
| `os_sleep` | `0x400c1f20` | GNU `--wrap` boundary | - |
| `pm_extend_tbtt_adaptive_attach` | `0x400d0d1e` | retained replacement only | - |
| `pm_extend_tbtt_adaptive_deattach` | `0x400d0d7a` | retained replacement only | - |
| `pm_funcs_deinit` | `0x400d0db4` | retained replacement only | - |
| `pm_funcs_init` | `0x400d0dc0` | retained replacement only | - |
| `pm_on_beacon_rx` | `0x400c3060` | direct public alias | `0x2f800e98` (ROM export) |
| `pm_on_coex_schm_status_config` | `0x2f005852` | retained replacement only | - |
| `pm_on_data_rx` | `0x400c3062` | direct public alias | `0x2f800e9c` (ROM export) |
| `pm_on_data_tx` | `0x400c3064` | direct public alias | `0x2f800ea0` (ROM export) |
| `pm_set_beacon_duration` | `0x400c3066` | retained replacement only | - |
| `pmksa_cache_deinit` | `0x400d0df8` | retained replacement only | - |
| `pmksa_cache_init` | `0x400d0e2a` | retained replacement only | - |
| `ppTxPkt` | `0x2f0088a4` | retained replacement only | - |
| `pp_create_task` | `0x400d0f74` | retained replacement only | - |
| `pp_delete_task` | `0x400d1002` | retained replacement only | - |
| `pp_post` | `0x400c0dbe` | GNU `--wrap` boundary | - |
| `rcGetSched` | `0x2f0029ce` | retained replacement only | - |
| `realloc` | `0x400c1d64` | GNU `--wrap` boundary | - |
| `sleep` | `0x400bb846` | GNU `--wrap` boundary | - |
| `sta_rx_cb` | `0x400adb5e` | GNU `--wrap` boundary | - |
| `trc_deinit` | `0x400d10ca` | retained replacement only | - |
| `trc_init` | `0x400d1110` | retained replacement only | - |
| `usleep` | `0x400bb8a2` | GNU `--wrap` boundary | - |
| `vTaskDelay` | `0x400bb8ce` | GNU `--wrap` boundary | - |
...
| `wDev_SnifferRxData` | `0x400c3064` | retained replacement only | - |
| `wDev_ftm_set_t1t4` | `0x400c3068` | retained replacement only | - |
| `wDev_isNANPktInValidSlot` | `0x400c3078` | GNU `--wrap` boundary | - |
| `wDev_record_ftm_data` | `0x400c3050` | retained replacement only | - |
| `wdev_csi_rx_process` | `0x400c3064` | retained replacement only | - |
| `wdev_data_init` | `0x400d11ca` | retained replacement only | - |
| `wifi_assert` | `0x400c3048` | retained replacement only | - |
| `wifi_deinit_in_caller_task` | `0x400d13be` | retained replacement only | - |
| `wifi_gpio_debug` | `0x400c3040` | retained replacement only | - |
| `wifi_init_in_caller_task` | `0x400d14a6` | retained replacement only | - |
| `wifi_log` | `0x400c3064` | retained replacement only | - |
| `wpa_ap_rx_eapol` | `0x400c26fa` | retained replacement only | - |
| `wpa_sm_rx_eapol` | `0x400c26bc` | retained replacement only | - |
| `wDev_DiscardFrame` | `0x2f0059d4` | direct public alias | `0x2f8010c8` (ROM export) |
| `wDev_ProcessRxSucData` | `0x2f006072` | direct public alias | `0x2f8010f4` (ROM export) |
| `ppRecycleRxPkt` | `0x2f004cb6` | direct public alias | `0x2f800f98` (ROM export) |
| `esp_wifi_internal_free_rx_buffer` | `0x2f004e26` | direct public alias | - |
| `esp_test_set_rx_error_occurs` | `0x400b7fca` | direct public alias | `0x2f801164` (ROM export) |
| `rcUpdateTxDone` | `0x400c2322` | direct public alias | `0x2f80106c` (ROM export) |
| `rcUpdateAckSnr` | `0x400c320c` | direct public alias | `0x2f801064` (ROM export) |
| `rcTxUpdatePer` | `0x400c325c` | direct public alias | `0x2f801060` (ROM export) |
| `lmacRequestTxopQueue` | `0x400de6fa` | direct public alias | - |
| `lmacReleaseTxopQueue` | `0x400de6d4` | direct public alias | - |
| `hal_get_tsf_time` | `0x2f008f22` | direct public alias | `0x2f82b9f8` (ROM export) |
| `hal_mac_rx_get_last_dscr` | `0x2f008f62` | direct public alias | `0x2f8386a2` (ROM export) |
| `hal_mac_tx_set_cca` | `0x2f008f9c` | direct public alias | - |
| `hal_mac_is_txq_valid` | `0x2f008f4e` | direct public alias | - |
| `hal_mac_set_txq_invalid` | `0x2f008f82` | direct public alias | - |
| `hal_mac_txq_disable` | `0x2f008fb4` | direct public alias | - |
| `hal_mac_set_csi_cbw` | `0x2f008f80` | direct public alias | - |
| `phy_set_rx_comp_new` | `0x2f008fe6` | direct public alias | - |
| `phy_dc_mem_clr` | `0x2f008fca` | direct public alias | - |
| `ieee80211_post_hmac_tx` | `0x400d1678` | direct public alias | `0x2f800cc0` (ROM export) |
| `ieee80211_crypto_encap` | `0x400c12d6` | direct public alias | `0x2f800cac` (ROM export) |
| `ieee80211_align_eb` | `0x400d1598` | direct public alias | `0x2f800c7c` (ROM export) |
| `ieee80211_set_tx_desc` | `0x400d1774` | direct public alias | `0x2f800c98` (ROM export) |
...
| `BAROFDMSched` | 12 | `internal SRAM` / `.data` | `libpp.a[trc.o]` | - |
| `BasicOFDMSched` | 12 | `internal SRAM` / `.data` | `libpp.a[trc.o]` | - |
| `rc11AXSchedTbl` | 192 | `internal SRAM` / `.data` | `libpp.a[trc.o]` | - |
| `rc11BSchedTbl` | 72 | `internal SRAM` / `.data` | `libpp.a[trc.o]` | - |
| `rc11GSchedTbl` | 156 | `internal SRAM` / `.data` | `libpp.a[trc.o]` | - |
| `rc11NSchedTbl` | 168 | `internal SRAM` / `.data` | `libpp.a[trc.o]` | - |
| `rcLoRaSchedTbl` | 24 | `internal SRAM` / `.data` | `libpp.a[trc.o]` | - |
