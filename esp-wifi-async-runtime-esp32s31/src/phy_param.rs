...
mod tests {
    use super::{
        apply_init_data, apply_rom_function_overrides, backup_parameter, recover_parameter,
        PhyRomFunctionOverrides, PhyRomFunctionTable, PHY_CALIBRATION_PAYLOAD_OFFSET,
        PHY_INIT_DATA_LEN, PHY_PARAM_LEN, PHY_ROM_TONE_SAR_DOUT_ADDRESS,
        PHY_ROM_TXCAL_DEBUG_MODE_ADDRESS,
    };
